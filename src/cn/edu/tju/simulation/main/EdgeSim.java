 ...
 */
	...
	/**
	 * Add a controller to the emulator and initialize the main window. 
	 * In addition, the main window adds listeners.
	 */
...
//			mainFrame.setExtendedState(JFrame.MAXIMIZED_BOTH); .
			...
			JSplitPane MapAndLogPanel = new JSplitPane(JSplitPane.VERTICAL_SPLIT);
	...
	private class MyActionListener implements WindowListener{
		...
		public void windowClosing(WindowEvent e) {
			if(Signal.SAVE == false){
				int choice = JOptionPane.showConfirmDialog(null,"The file has not been saved, whether to quit?","Prompt",JOptionPane.YES_NO_OPTION);
				if(choice == 0){
